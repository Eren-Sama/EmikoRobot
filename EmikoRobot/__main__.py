...
PM_START_TEXT = """
*Hola {} !*
✪ ɪ'ᴍ ɢɪʏᴜ ᴀɴ ᴀɴɪᴍᴇ ᴛʜᴇᴍᴇᴅ ᴀᴅᴠᴀɴᴄᴇᴅ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ ᴀ ʟᴏᴛ ᴏғ sᴛᴜɴɴɪɴɢ ғᴇᴀᴛᴜʀᴇs[🔥](https://telegra.ph/file/487942517d92244580563.mp4)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
HELP_STRINGS = """
ʜᴇʏ ᴛʜᴇʀᴇ, ɪ'ᴍ ɢɪʏᴜ ᴛᴏᴍɪᴏᴋᴀ ! ᴀ ᴘᴏᴡᴇʀғᴜʟ ʜᴀsʜɪʀᴀ ᴡʜᴏ ᴀɪᴍ ᴛᴏ ᴇʀᴀᴅɪᴄᴀᴛᴇ ᴀʟʟ ᴛʜᴇ ᴅᴇᴍᴏɴs ᴘʀᴇsᴇɴᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘs ɪɴ ᴏʀᴅᴇʀ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
ʜᴀᴠᴇ ᴀ ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ғᴏʀ ᴀɴ ɪᴅᴇᴀ ᴏғ sᴏᴍᴇ ᴏғ ᴛʜᴇ ᴛʜɪɴɢs ɪ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴡɪᴛʜ. ᴛᴏ ᴍᴀᴋᴇ ᴍᴇ ꜰᴜɴᴄᴛɪᴏɴᴀʟ, ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴀᴛ ɪ ʜᴀᴠᴇ ᴇɴᴏᴜɢʜ ʀɪɢʜᴛꜱ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
...
ᴊᴏɪɴ ᴍʏ ꜱᴜᴘᴘᴏʀᴛ ɪꜰ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ Qᴜᴇʀɪᴇꜱ: @GiyuSupport

ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅꜱ ᴄᴀɴ ʙᴇ ᴜꜱᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ꜰᴏʟʟᴏᴡɪɴɢ: / !
ʟɪꜱᴛ ᴏꜰ ᴀʟʟ ᴛʜᴇ ᴍᴏᴅᴜʟᴇꜱ: ᴜsᴇ /Help"""
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Giyu*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Giyu's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for GiyuBot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
